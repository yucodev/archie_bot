...
async def on_message(message):
    ...
    if message.content.startswith('!weather'):
        ...
        for forecast in forecasts:
            await client.send_message(message.author, msg), '**On ' + forecast.date + '**')
            await client.send_message(message.author, msg), ' :low_brightness: ' + forecast.text)
            await client.send_message(message.author, msg), ' :small_orange_diamond: Max temp. ' + forecast.high)
            await client.send_message(message.author, msg), ' :small_blue_diamond: Min temp. ' + forecast.low)
