...
async def on_message(message):
    ...
    if message.content.startswith('!weather'):
        ...
        await client.send_message(ctx.message.author, '**_WEATHER FORECAST GIJON_**')
        ...
        for forecast in forecasts:
            ...
            await client.send_message(ctx.message.author, ' :small_blue_diamond: Min temp. ' + forecast.low)
